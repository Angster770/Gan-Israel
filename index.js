...
const dbUrl = process.env.DB_URL || 'mongodb://localhost:27017/gan-israel';
...
const secret = process.env.SECRET || 'Moshiachishere';
    ...
    helmet.contentSecurityPolicy({
        directives: {
            ...
            imgSrc: [
                ...
                "blob:",
                "data:",
                "https://res.cloudinary.com/dzmgiq9rb/", //SHOULD MATCH YOUR CLOUDINARY ACCOUNT! 
